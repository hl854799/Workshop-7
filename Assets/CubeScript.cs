...
public class CubeScript : MonoBehaviour
{
    ...
    Mesh CreateCubeMesh()
    {
        ...
        Vector3 topNormal = new Vector3(0.0f, 0.0f, 0.0f);
        Vector3 bottomNormal = new Vector3(0.0f, 0.0f, 0.0f);
        Vector3 leftNormal = new Vector3(0.0f, 0.0f, 0.0f);
        Vector3 rightNormal = new Vector3(0.0f, 0.0f, 0.0f);
        Vector3 frontNormal = new Vector3(0.0f, 0.0f, 0.0f);
        Vector3 backNormal = new Vector3(0.0f, 0.0f, 0.0f);
